...
class Fleecehoodie101 extends StatelessWidget {
...
class VelvetHoodie extends StatefulWidget {
  ...
  @override
  State<VelvetHoodie> createState() => _FleeceHoodieState();
}

enum Animals { White, lion, tiger }

class _FleeceHoodieState extends State<VelvetHoodie> {
  String? hoodietitle = 'Fleece Hoodie';
  String? productid = '101_Fleece';
  String? hoodieSize = '';
  String? hoodieColors = '';
  @override
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: Color.fromARGB(255, 255, 243, 252)),
              child: Container(
                  height: 250,
                  width: 300,
                  // color: Colors.black,
                  child: Image.asset(
                    'assets/images/Descriptive_Product/Fleece101_black.png',
                  ))),
          Container(
            height: 10,
            width: 20,
